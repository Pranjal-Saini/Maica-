...
Every number these produce is a GROUP BY. Loading 52,000 Record rows to count
them in Python is the same shape of mistake that once made a 5,000-record
account unusable, so none of that happens here.
